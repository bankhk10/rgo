<x-app-layout>
            ...
            <div>
                ...
                <div class="grid grid-cols-3 md:grid-cols-2 gap-6 mt-4">
                    ...
                    <div>
                        ...
                        <div class="dropdown" id="positionDropdown"> {{-- เปลี่ยน id เป็น positionDropdown --}}
                            <div style="height: 50px;" class="text-gray-500 dropdown-btn" id="positionBtn">--
                                เลือกตำแหน่ง --</div> {{-- เปลี่ยน id เป็น positionBtn --}}
                            <div class="dropdown-list" id="positionList"> {{-- เปลี่ยน id เป็น positionList --}}
            ...
            <div>
                ...
                <div class="grid grid-cols-3 md:grid-cols-2 gap-6 mt-4">
                    ...
                    <div>
                        ...
                        <input type="hidden" name="role_id" id="roleInput" value="{{ old('role_id') }}">
                        @error('role_id')
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            setupDropdown('positionBtn', 'positionList', 'positionInput', "{{ old('position') }}");

            // Setup for 'department' dropdown
            setupDropdown('departmentBtn', 'departmentList', 'departmentInput', "{{ old('department') }}");
