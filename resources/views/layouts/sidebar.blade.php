<div :class="sidebarOpen ? 'translate-x-0 ease-out' : '-translate-x-full ease-in'"
    ...
    <div class="flex items-center justify-center mt-2">
        <div class="flex items-center">
            <img class="object-cover w-28 h-23"
                 alt="Logo"
                 src="/images/logo.png">
            ...
            <a href="{{ route('admin.dashboard') }}">
                {{-- <span class="text-white text-2xl mx-2 font-semibold">ICG</span> --}}
            </a>
        </div>
    </div>
        ...
        @canany('Post access', 'Post add', 'Post edit', 'Post delete')
            <a class="flex items-center mt-4 py-2 px-6 text-gray-500 hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100 {{ Route::currentRouteNamed('admin.posts.index') ? 'active' : '' }}"
               href="{{ route('admin.posts.index') }}">
                ...
                <span class="mx-3">ข้อมูลการขึ้นทะเบียน</span>
            </a>
            {{-- เพิ่มเมนูข้อมูลทะเบียนการผลิต --}}
            <a class="flex items-center mt-4 py-2 px-6 text-gray-500 hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100 {{ Route::currentRouteNamed('admin.production.index') ? 'active' : '' }}"
               href="{{ route('admin.production.index') }}">
                <svg class="h-6 w-6"
                    ...
                    <path stroke-linecap="round"
                          stroke-linejoin="round"
                          stroke-width="2"
                          d="M9 17v-6h13v6M9 17H5a2 2 0 01-2-2V7a2 2 0 012-2h4m0 0V3m0 2v2">
                    </path>
                </svg>
                <span class="mx-3">ข้อมูลทะเบียนการผลิต</span>
            </a>
            {{-- เพิ่มเมนูทะเบียนนำเข้า --}}
            <a class="flex items-center mt-4 py-2 px-6 text-gray-500 hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100 {{ Route::currentRouteNamed('admin.import.index') ? 'active' : '' }}"
               href="{{ route('admin.import.index') }}">
                ...
                <span class="mx-3">ทะเบียนนำเข้า</span>
            </a>
        @endcanany
