    ...
    <div class="max-w-5xl mx-auto p-8 bg-white shadow-lg rounded-2xl space-y-10 mt-6">
        ...
        <div>
            ...
            <div class="grid grid-cols-2 md:grid-cols-2 gap-6 mt-4">
                ...
                <div>
                    <label class="mx-3 text-base block text-gray-700 mb-1 mt-3">ปริมาณนำเข้า</label>
                    <p class="w-full p-3 border rounded-full bg-gray-100 text-gray-700">
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea disabled name="packaging_size_details" placeholder=""
                        class="text-gray-700 bg-gray-100 w-full p-3 border rounded-2xl" rows="2">{{ old('packaging_size_details', $product->packaging_size_details) }}</textarea>
                </div>
            </div>
        </div>
        {{-- Action Buttons --}}
