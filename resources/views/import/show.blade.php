        ...
        <div>
            ...
            <div class="grid grid-cols-2 md:grid-cols-2 gap-6 mt-4">
                ...
                <div>
                    ...
                    <p class="w-full p-3 border rounded-full bg-gray-100 text-gray-700">{{ beDate($product->expired_at) }}</p>
                </div>
                ...
                <div>
                    ...
                    <p class="w-full p-3 border rounded-full bg-gray-100 text-gray-700">{{ beDate($product->possession_form_expiry) }}</p>
                </div>
