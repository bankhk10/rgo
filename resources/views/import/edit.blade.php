    ...
    <div class="max-w-5xl mx-auto p-6 bg-white shadow-lg rounded-2xl space-y-6 mt-6">
        ...
        <form method="POST" action="{{ route('import.update', $import->id) }}"
            ...
            <div>
                ...
                <input type="number" step="0.01" name="import_quantity"
            ...
            <div class="col-span-2">
                <label class="block text-gray-700 mb-1">ขนาดบรรจุ</label>
                <textarea name="packaging" rows="1" class="w-full p-2 border rounded-lg">{{ old('packaging', $import->packaging) }}</textarea>
            </div>

            {{-- หมายเหตุ --}}
            <div class="col-span-2">
                <label class="block text-gray-700 mb-1">หมายเหตุ</label>
                <textarea name="note" rows="1" class="w-full p-2 border rounded-lg">{{ old('note', $import->note) }}</textarea>
            </div>
            ...
            <div class="col-span-2 flex justify-between mt-6">
                ...
                <button type="submit" class="bg-blue-800 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-lg">
                    บันทึก
                </button>
            </div>
        </form>
